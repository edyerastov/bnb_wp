...
<fieldset>
    <legend>Шорткоды и хуки плагина</legend>
    <div class="table-responsive">
        <table class="table">
            ...
            <tbody>
                ...
                <tr>
                    <td class="active">Событие нового заказа</td>
                    <td class="success">Вызов add_action('buy_click_new_order', 'Ваша функция', 100, 2);</td>
                    <td class="warning">Событие(хук) возникает при формировании нового заказа через форму плагина. В качестве 
                        аргументов принимает два массива 1-й Результат работы функции, 2 - данные отправляемые в журнал заказов плагина   </td>
