...
<form method="post" action="options.php">
    ...
    <fieldset>
        ...
        <table class="form-table">
            <tr valign="top">
                <th scope="row">Включить SMS уведомления Клиентов</th>
                <td>
                    ...
                    ?>/>
                    <span class="description">Включить функции СМС уведомлений для клиента через сервис "<a href="http://smsc.ru/?ppzixn.ru" target="_blank">SMSC</a>" для кнопки быстрого заказа. Если галочка установлена — смс уведомления будут работать.</span>
                </td>
            </tr>
            <tr valign="top">
                <th scope="row">Включить SMS уведомления Продавца</th>
                <td>
                    ...
                    ?>/>
                    <span class="description">Включить функции СМС уведомлений для продавца через сервис  — Если галочка установлена — смс уведомления будут работать.</span>
                </td>
            </tr>
            <tr valign="top">
                <th scope="row">Телефон владельца интернет магазина</th>
                <td>
                    ...
                    ?>" />
                    <span class="description">На этот номер телефона будут приходить уведомления о новых заказах. Работает при установленной галке выше</span>
                </td>
            </tr>
            <tr valign="top">
            ...
            <tr valign="top">
                <th scope="row">Шаблон SMS сообщения Клиента</th>
                <td>
            ...
            <tr valign="top">
                <th scope="row">Шаблон SMS сообщения Продавца</th>
                <td>
                    <textarea cols="50" rows="5" name="buysmscoptions[smshablon_saller]" required><?php
                        if (isset($buysmscoptions['smshablon_saller'])) {
                            echo $buysmscoptions['smshablon_saller'];
                        }
                        ?></textarea>
                    <span class="description">Указанный шаблон «%Имя шаблона%»  будут преобразован в информацию из формы. Так же вы можете вписать произвольный текст.
                        Например: "Внимание, поступил новый заказ от %FIO%, срочно перезвони клиенту - %TPRICE%"</span>
                </td>
